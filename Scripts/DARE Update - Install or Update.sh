...
# Parameter labels:
#
# Parameter 4 - Application Identifier (Use the Installation Format from the DARE Update App Catalog - E.g. com.google.Chrome)
...
# Parameter 7- Deferrals Allowed (Only applicable if specifying "update" as the action. This is the amount of times a user can defer an update prompt before being forced to update. Leave blank for no deferrals and just a grace period timer)
